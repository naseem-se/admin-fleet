        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="rounded-lg border border-blue-100 bg-blue-50 p-3">
            <p className="text-xs font-medium text-blue-800 mb-2">
              When is the NEXT one of these due? Fill in either field below (or both) and the system will automatically alert you when it's approaching — you won't need to remember to check.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div>
              ...
              <div>
                ...
                <input {...register("next_service_km")} placeholder="e.g. 50000" className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none" />
              </div>
            </div>
          </div>
